...
import { ReactComponent as SvgLogo } from '../../assets/Svg/BlackBackgroundLogo.svg'
      ...
      >
        <div className="aside-wrapper">
          ...
          >
            ...
            <span className="switch__color mt-2" style={{ fontSize: '1.2rem' }}>
              Code Web
            </span>
          </Link>
