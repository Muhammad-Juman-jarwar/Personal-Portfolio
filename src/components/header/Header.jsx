...
import profileImg from '../../assets/images/boy2.png'
import './header.scss'

const nameArray = ['M', '.', 'J' , 'u', 'm', 'a', 'n']
const jobArray = [
  'w',
  'e',
  'b',
    ...
    <>
      <section className="section-1 header__container section__padding">
        <main className="intro-page">
          ...
          <h1 arial-label="Hi i'm Muhammad Juman, web Junior full-stack developer" className='txt-1'>
